...
frontend/src/features/catalog/  cases, executions, and detail pages
...
For repo-wide setup and contributor workflow, see [docs/developer/index.md](../docs/developer/index.md).
